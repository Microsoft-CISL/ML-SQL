...
namespace ML2SQL
{
    public class RunResult
    {
        ...
        public int elementProcessed { get; set; }
        public string executionMode { get; set; }

        public RunResult(string name,string inputMode,string outputMode,string dbms, int batchSize, float timeWithOutConnection, float timeWithConnection, int elementProcessed,string executionMode)
        {
