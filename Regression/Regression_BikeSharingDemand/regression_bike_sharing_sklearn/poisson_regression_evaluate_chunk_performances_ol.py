...
from Regression.Regression_BikeSharingDemand.regression_bike_sharing_sklearn.regression_bike_sharing_poisson import BikeRegressionPoissonPipeline


if __name__ == '__main__':
    brftp = BikeRegressionPoissonPipeline("hour_all_with_id.csv", "hour_train_with_id.csv", "hour_test_with_id.csv")
