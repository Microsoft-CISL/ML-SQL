delimiter //
set names utf8;
drop procedure if exists MLtoSQL.taxi_fare_no_output;
CREATE procedure MLtoSQL.taxi_fare_no_output(num INT, chuncksize INT)
wholeblock:BEGIN
SET @id = 1;
WHILE @id <= num DO
 select count(1) from (Select Id, (SUM(dot_product) + 14.71098 ) as Score
