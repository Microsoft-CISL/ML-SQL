 select count(1) from (select Id,(EXP(class_0) / (EXP(class_0)+EXP(class_1)+EXP(class_2))) as class_0,(EXP(class_1) / (EXP(class_0)+EXP(class_1)+EXP(class_2))) as class_1,(EXP(class_2) / (EXP(class_0)+EXP(class_1)+EXP(class_2))) as class_2
